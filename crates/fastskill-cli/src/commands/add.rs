...
"#;
        ...
        let skill_id = fastskill_core::SkillId::new("test-skill-no-toml".to_string()).unwrap();
...
"#;
        ...
        let skill_id = fastskill_core::SkillId::new("from-toml".to_string()).unwrap();
        let skill = service.skill_manager().get_skill(&skill_id).await.unwrap();
...
"#;
        ...
        let skill_id = fastskill_core::SkillId::new("fallback-name-skill".to_string()).unwrap();
        let skill = service.skill_manager().get_skill(&skill_id).await.unwrap();
