...
fastskill read my-skill --tree    # Inspect a skill and its dependency tree
...
- `fastskill init` for the manifest, `marketplace create` for a catalog
...
- [CLI reference](/cli-reference/overview) and [tooling commands](/cli-reference/tooling-commands) (`doctor`, `analyze`, …)
