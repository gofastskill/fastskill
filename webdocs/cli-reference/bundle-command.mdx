...
Install a local artifact or an HTTPS download with `bundle add`:

```bash
fastskill bundle add ./payments-team-1.2.0.zip
fastskill bundle add https://releases.example.com/payments-team-1.2.0.zip
...
```bash
fastskill bundle update payments-team --from ./payments-team-1.3.0.zip --dry-run
fastskill bundle update payments-team --from ./payments-team-1.3.0.zip
```
...
fastskill bundle remove payments-team --force
```
