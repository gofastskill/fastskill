...
description: Build, install, update, and restore self-contained project exports.
---
...
Those existing artifacts remain supported through `fastskill bundle override <skill-id> --from
<directory>` and `fastskill bundle override <skill-id> --reset`. Manifest-driven builds make all
