---
title: "repo commands"
description: "Manage skill repositories and browse the remote catalog with fastskill repo."
---
...
- Use for Git repositories and private registries
  ...
  - Example:
    ```bash
    fastskill repo add private-repo --repo-type git-marketplace https://github.com/team/repo.git \
...
- Use for Git repositories with SSH access
  ...
  - Example:
    ```bash
    fastskill repo add private-repo --repo-type git-marketplace git@github.com:team/repo.git \
