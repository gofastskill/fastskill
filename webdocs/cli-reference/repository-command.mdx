---
title: "repos Command"
description: "Manage skill repositories and browse the remote catalog with fastskill repos."
---
...
fastskill repos add stable-skills --repo-type git-marketplace https://github.com/team/skills.git --tag v1.2.0
...
Installation: fastskill add acme/web-scraper@latest --repository my-registry
...
<Accordion id="authentication-failed" title="Authentication failed">
  <Callout type="warn">
  **Verify credentials**:
  ```bash
...
<Accordion id="priority-not-working" title="Priority not working">
  <Callout>
