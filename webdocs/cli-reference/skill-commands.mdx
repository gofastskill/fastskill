...
fastskill init --set-version 1.2.3
...
fastskill update my-skill-id --to-version 2.1.0
```
...
fastskill add scope/reviewer@latest --repository team

# Add an exact cached release without network access
fastskill add scope/reviewer@1.2.0 --repository team --offline
```
