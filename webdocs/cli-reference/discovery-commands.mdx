...
- **Repository Management**: Use `fastskill repos` for all repository operations (add, remove, list, info, update, test, refresh) and catalog browsing (skills, show, versions)
