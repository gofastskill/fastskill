...
| List registry skills | `fastskill registry list-skills` | Lists all skills from HTTP registry (table format) |
...
| Search skills | `fastskill search query` | Searches for skills across repositories (default: remote) |
