---
title: "FastSkill"
description: "Install, lock, bundle, discover, evaluate, and operate AI agent skills."
---
...
```bash
fastskill -V
fastskill project init            # in a skill directory, when authoring
fastskill skill add ./my-skill -e --group dev
fastskill project install
fastskill skill list
```

Then optional: `fastskill index rebuild`, `fastskill skill search "…" --local`, `fastskill eval validate`, `fastskill cli doctor`. Full walkthrough: [Quick start](/quickstart).
...
<img src="/images/hero-diagram.svg" alt="Declare, lock, and ship workflow in FastSkill" />
