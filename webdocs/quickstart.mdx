...
description: Install a local skill, verify it, and make it available to an agent without an API key.
---
...
## 1. Create a project and a skill
...
## 4. Restore the recorded selection
