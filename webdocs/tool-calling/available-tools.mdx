...
<Note>
The `get_available_tools()` method currently returns an empty list. This is the interface contract for tool discovery. To discover tools, use the search and list commands to find skills, then read their SKILL.md files to see the tools they define.
</Note>
