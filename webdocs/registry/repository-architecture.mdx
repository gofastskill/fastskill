...
# Add new repository
fastskill repos add team-tools --repo-type git-marketplace \
...
# Update repository
fastskill repos update team-tools --priority 0
...
fastskill repos add github-skills \
...
fastskill repos add gitlab-skills \
  --repo-type git-marketplace \
...
- [repos Command](/cli-reference/repository-command) - Repository management CLI
...
- [init Command](/configuration/init-command) - Project initialization options
