...
**Publish to Registry:**
Requires a FastSkill build compiled with the `registry-publish` feature.
...
fastskill publish \
  --artifacts ./artifacts \
  --api-url https://registry.yourcompany.com \
  --wait true

# Check publish status
curl -H "Authorization: Bearer $FASTSKILL_API_TOKEN" \
  https://registry.yourcompany.com/api/v1/registry/publish/status/{job_id}
```
