---
title: Configure skill sources
description: Add skills from Git and configure local, Git marketplace, HTTP, and ZIP catalogs.
---
...
`skill add`, `skill remove`, or `project install`. A `/tree/` URL in a manifest that
